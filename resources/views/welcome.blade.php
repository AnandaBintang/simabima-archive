...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <section class="lp-features" id="fitur">
            <div class="lp-section-center">
                <span class="lp-section-tag">Fitur Unggulan</span>
                <h2 class="lp-section-title">Semua yang Anda Butuhkan</h2>
                <p class="lp-section-sub">
                    Dari eksplorasi arsip hingga manajemen pengguna, SIMABIMA menyediakan solusi lengkap
                    untuk pengelolaan arsip digital organisasi Anda.
                </p>
            </div>

            <div class="lp-features-grid">
                <div class="lp-feature-card">
                    <div class="lp-feature-icon icon-blue">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
                    </div>
                    <div class="lp-feature-title">Eksplorasi Arsip</div>
                    <div class="lp-feature-desc">
                        Telusuri arsip berdasarkan unit organisasi secara hierarkis — dari bagian, sub-bagian, hingga dokumen individu.
                    </div>
                </div>
                <div class="lp-feature-card">
                    <div class="lp-feature-icon icon-gold">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    </div>
                    <div class="lp-feature-title">Manajemen Pengguna</div>
                    <div class="lp-feature-desc">
                        Kelola akun pengguna dengan peran Admin, Operator, dan Staf — masing-masing dengan hak akses yang berbeda.
                    </div>
                </div>
                <div class="lp-feature-card">
                    <div class="lp-feature-icon icon-green">
                    ...
                    <div class="lp-feature-title">Kategori Arsip</div>
                    <div class="lp-feature-desc">
                        Klasifikasikan dokumen dengan kategori yang dapat disesuaikan untuk pencarian dan pengelompokan yang mudah.
                    </div>
                </div>
                <div class="lp-feature-card">
                    <div class="lp-feature-icon icon-blue">
                    ...
                    <div class="lp-feature-title">Unduh Dokumen</div>
                    <div class="lp-feature-desc">
                        Unduh file arsip langsung dari halaman eksplorasi atau detail arsip dengan satu klik yang mudah.
                    </div>
                </div>
                <div class="lp-feature-card">
                    <div class="lp-feature-icon icon-gold">
                    ...
                    <div class="lp-feature-title">Dashboard Statistik</div>
                    <div class="lp-feature-desc">
                        Pantau ringkasan jumlah arsip, arsip terbaru, dan grafik pertumbuhan dokumen secara real-time.
                    </div>
                </div>
                <div class="lp-feature-card">
                    <div class="lp-feature-icon icon-green">
                    ...
                    <div class="lp-feature-title">Akses Berbasis Peran</div>
                    <div class="lp-feature-desc">
                        Kebijakan akses yang ketat memastikan setiap pengguna hanya dapat melakukan tindakan sesuai perannya.
                    </div>
                </div>
            </div>
        </section>
